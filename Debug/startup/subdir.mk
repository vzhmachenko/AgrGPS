...
startup/%.o: ../startup/%.s
	...
	@echo $(PWD)
	arm-none-eabi-as -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -I"/home/valentyn/workspace/AgrGPS/CMSIS/core" -I"/home/valentyn/workspace/AgrGPS/CMSIS/device" -I"/home/valentyn/workspace/AgrGPS/inc" -I"/home/valentyn/workspace/AgrGPS/RTOS/inc" -g -o "$@" "$<"
